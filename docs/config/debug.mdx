...
```bash
# Start DBHub with HTTP transport
npx @artern/dbhub@latest --transport http --port 8080 --dsn "postgres://user:password@localhost:5432/mydb"
...
![MCP Inspector with DBHub](https://raw.githubusercontent.com/artern/dbhub/main/docs/images/mcp-inspector.webp)
...
npx @artern/dbhub@latest --transport http --port 8080 --dsn "your-dsn" --log-level debug
```
